...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '9780593fe23f91bed8-64239685',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_593fe2402b756',
  'variables' => 
  array (
    'cate_list' => 0,
    'v' => 0,
...
<?php if ($_valid && !is_callable('content_593fe2402b756')) {function content_593fe2402b756($_smarty_tpl) {?><!DOCTYPE html>
...
?>	  
					<li>
					  <a href='<?php echo U("Home/Video/movie_show?order=".($_smarty_tpl->tpl_vars['v']->value['vt_id']));?>
'><?php echo $_smarty_tpl->tpl_vars['v']->value['typename'];?>
			...
			<div class="ui-bar fn-clear">
				...
				<div class="view-filter">
					<a id="time" href='<?php echo U("Home/Video/movie_show?sequence=publishedTime");?>
' class="order" target="_self"><span>按时间</span></a>
					<a id="hits" href='<?php echo U("Home/Video/movie_show?sequence=numOfViewed");?>
