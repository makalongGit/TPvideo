<?php /* Smarty version Smarty-3.1.6, created on 2017-06-13 20:37:09
    ...
    <div class="mod">
	    <div class="rowL">
	        <div class="pg-tab cfix">
	        	<span class="cur"><a href='<?php echo U("Home/Game/youxi?sequence=numofviewed");?>
' npb-txid="wm-2_wm-2-zshy-tag-bt_11">本周主打</a></span>         
	            <span><a href='<?php echo U("Home/Game/youxi?sequence=publishedtime");?>
