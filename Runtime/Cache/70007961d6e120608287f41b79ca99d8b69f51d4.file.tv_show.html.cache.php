<?php /* Smarty version Smarty-3.1.6, created on 2017-06-13 23:46:11
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_594008c3b1fa6',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_594008c3b1fa6')) {function content_594008c3b1fa6($_smarty_tpl) {?><!DOCTYPE html>
...
?>
					<li>
					  <a href='<?php echo U("Home/Video/tv_show?order=".($_smarty_tpl->tpl_vars['v']->value['vt_id']));?>
'><?php echo $_smarty_tpl->tpl_vars['v']->value['typename'];?>
			...
			<div class="ui-bar fn-clear">
				...
				<div class="view-filter">
					<a id="time" href='<?php echo U("Home/Video/tv_show?sequence=publishedTime");?>
' class="order" target="_self"><span>按时间</span></a>
					<a id="hits" href='<?php echo U("Home/Video/tv_show?sequence=numOfViewed");?>
...
" style="display: block;">
									...
									<i class="bgbbg"></i>
									<p class="name">HD高清</p>
									<p class="other">剧情：<?php echo $_smarty_tpl->tpl_vars['v']->value['introduction'];?>
</p>
									</span>
								</div>
								<div class="text">
									<p class="name"><?php echo $_smarty_tpl->tpl_vars['v']->value['videoname'];?>
</p><p class="actor">发布时间:<?php echo $_smarty_tpl->tpl_vars['v']->value['publishedtime'];?>
</p>
								</div>
							</a>
						</li>
